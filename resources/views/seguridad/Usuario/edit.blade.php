            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="col-lg-6">
                        <div class="form-group{{ $errors->has('tpersona') ? ' has-error' : '' }}">
                            ...
                            <div class="col-lg-8">
                                <select id="tusuario" name="tusuario" class="form-control">
                                    ...
                                    <option value="{{$tusu->tusu_id}}" {{($tusu->tusu_id==$usuario->tusu_id)?'selected':''}}>{{$tusu->tusu_nombre}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group{{ $errors->has('tdocumento') ? ' has-error' : '' }}">
                            ...
                            <div class="col-lg-8">
                                <select id="tdocumento" name="tdocumento" class="form-control">
                                    ...
                                    <option value="{{$tdoc->tdoc_id}}" {{($tdoc->tdoc_id==$usuario->tdoc_id)?'selected':''}}>{{$tdoc->tdoc_nombre}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group{{ $errors->has('documento') ? ' has-error' : '' }}">
                            ...
                            <div class="col-lg-8">
                                <input type="text" name="documento" value="{{$usuario->documento}}" class="form-control text-uppercase" placeholder="Nro de documento..." title="Debe ingresar un número de documento válido" required>
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-lg-8">
                                <input id="email" type="mail" name="email" value="{{$usuario->email}}" class="form-control text-uppercase" placeholder="Correo electrónico del usuario..." required="required" title="Debe ingresar el correo electrónico del usuario">
                                @if($errors->has('email'))
                                    <span class="help-block">
                        ...
                        <div id="contapepat" class="form-group{{ $errors->has('apepaterno') ? ' has-error' : '' }}">
                            ...
                            <div class="col-lg-8">
                                <input id="apepaterno" type="text" name="apepaterno" value="{{$usuario->apellidoPaterno}}" class="form-control text-uppercase" placeholder="Ap. Paterno usuario..." required="required" title="Debe ingresar el apellido paterno del usuario">
                    ...
                    <div class="col-lg-6">
                        <div id="contapemat" class="form-group{{ $errors->has('apematerno') ? ' has-error' : '' }}">
                            ...
                            <div class="col-lg-8">
                                <input id="apematerno" type="text" name="apematerno" value="{{$usuario->apellidoMaterno}}" class="form-control text-uppercase" placeholder="Ap. Materno usuario..." required="required" title="Debe ingresar el apellido materno del usuario">
                        ...
                        <div id="contnombres" class="form-group{{ $errors->has('nombres') ? ' has-error' : '' }}">
                            ...
                            <div class="col-lg-8">
                                <input id="nombres" type="text" name="nombres" value="{{$usuario->nombres}}" class="form-control text-uppercase" placeholder="Nombres del usuario..." required="required" title="Debe ingresar el/los nombre(s) del usuario">
                ...
                <div class="panel-footer text-right">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fa fa-btn fa-user"></i> Actualizar usuario
                    </button>
                </div>
            </div>
